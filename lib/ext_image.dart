...
///
/// If the image is later used by an [ExtImage] or [BoxDecoration] or [FadeInImage],
...
/// Signature used by [ExtImage.frameBuilder] to control the widget that will be
/// used when an [ExtImage] is built.
///
...
/// it will yield the same result as if [ExtImage.frameBuilder] was null.
///
...
/// See also:
///
///  * [ExtImage.frameBuilder], which makes use of this signature in the [ExtImage]
///    widget.
...
/// Signature used by [ExtImage.loadingBuilder] to build a representation of the
...
/// be non-null. Typically, this builder will wrap the `child` widget in some
/// way and return the wrapped widget. If this builder returns `child` directly,
/// it will yield the same result as if [ExtImage.loadingBuilder] was null.
///
...
/// See also:
///
///  * [ExtImage.loadingBuilder], which makes use of this signature in the [ExtImage]
///    widget.
...
/// Signature used by [ExtImage.errorBuilder] to create a replacement widget to
...
/// or [MediaQuery] widget exists above the [ExtImage] widget in the widget tree.
///
...
///
/// {@tool snippet}
/// The [ExtImage] Widget also provides several constructors to display different
...
class ExtImage extends StatefulWidget {
  ...
  ///
  /// If a [loadingBuilder] is specified for an image, the [ExtImage] widget is
  ...
  ///
  /// We have constructed a 'Person' widget that displays an avatar [ExtImage] of
  /// the currently loaded person along with their name. We could request for a
  /// new person to be loaded into the widget at any time. Suppose we have a
  /// person currently loaded and the widget loads a new person. What happens
  /// if the [ExtImage] fails to load?
  ///
  ...
  @override
  State<ExtImage> createState() => _ExtImageState();
...
class _ExtImageState extends State<ExtImage> with WidgetsBindingObserver {
  ...
  late DisposableBuildContext<State<ExtImage>> _scrollAwareContext;
  ...
  void initState() {
    ...
    _scrollAwareContext = DisposableBuildContext<State<ExtImage>>(this);
  }
  ...
  @override
  void didUpdateWidget(ExtImage oldWidget) {
